...
namespace TunnelDweller.VarMod.Speed
{
    internal static class SpeedHack
    {
        ...
        internal static Slider slSpeed = new Slider("Timescale", 100, 1, 1000f, 0);
        ...
        public static void Initialize()
        {
            ...
            //cbEnabled.Checked = Varm.Config.SpeedEnabled;
            //slSpeed.Value = Varm.Config.Speed;
        ...
        private static void Update_OnUpdate(object sender, EventArgs e)
        {
            ...
            //Varm.Config.Speed = slSpeed.Value;
